...
$(document).ready(function () {
    $('.view-btn').on('click', function () {
        ...
        $('#modal-name').text(patient.user?.name || '');
        $('#modal-email').text(patient.user?.email || '');
        $('#modal-phone').text(patient.phone || '');
        $('#modal-gender').text(patient.gender || '');
        $('#modal-dob').text(patient.date_of_birth || '');
        $('#modal-address').text(patient.address || '');
        $('#modal-blood').text(patient.blood_type || '');
        $('#modal-emergency').text(patient.emergency_contact || '');
    ...
    $('#addPatientBtn').on('click', function () {
        $('#patientForm')[0].reset();
        $('#patient-id').val('');
        $('#patientFormModalLabel').text('Add Patient');
    ...
    $('.edit-btn').on('click', function () {
        ...
        $('#alternatephone').val(patient.emergency_contact || '');
    ...
    $('#patientForm').on('submit', function (e) {
        ...
        const url = isEdit
            ? `${API_BASE_URL}/api/v1/admin/patients/${patientId}`
            : `${API_BASE_URL}/api/v1/patients/register`;
        ...
        if(method == "POST") {
            payload = {
                ...
                emergency_contact: $('#alternatephone').val()
            };
        }
        else {
            payload = {
